...
from HOPcardAPI_app.views import QuizViewSet, ActionViewSet, QuizSelectViewSet, ActSelectViewSet, QuizTFViewSet, ActTFViewSet, PlayerViewSet, LRViewSet
...
router.register(r'lrs', LRViewSet)
